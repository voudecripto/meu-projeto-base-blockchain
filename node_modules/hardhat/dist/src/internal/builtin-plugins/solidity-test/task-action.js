...
const runSolidityTests = async ({ testFiles, chainType, grep, noCompile, verbosity }, hre) => {
    ...
    const artifactsManager = new ArtifactManagerImplementation(artifactsDirectory);
    ...
    const config = await solidityTestConfigToSolidityTestRunnerConfigArgs(chainType, hre.config.paths.root, solidityTestConfig, verbosity, observabilityConfig, grep);
    const tracingConfig = {
        buildInfos,
