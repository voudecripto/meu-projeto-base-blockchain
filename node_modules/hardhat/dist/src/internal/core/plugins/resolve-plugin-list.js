    ...
    while (resolvedPlugins.length !== lastResolvedCount) {
        ...
        for (const plugin of resolvedPlugins) {
            ...
            for (const conditionalDependency of plugin.conditionalDependencies) {
                ...
                try {
                    conditionModules = await Promise.all(conditionalDependency.condition());
                }
                catch (_error) {
                    continue;
                }
                // Check all condition plugins are loaded
                if (conditionModules.some((conditionPlugin) => !resolvedPlugins.includes(conditionPlugin.default))) {
                    continue;
                }
